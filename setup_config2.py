...
from config2_helpers import Worker, recover, docker
...
if __name__ == '__main__':
    ...
    evidence.append({'type': 'image', 'value': docker('image', 'inspect', 'project1-client-config2:1').stdout})
    Path('config2_deployment.json').write_text(json_util.dumps(evidence, indent=2))
